...
import left from '../../public/images/hero/left.jpeg'
import right from '../../public/images/hero/right.jpeg'
export default function CyberpunkHero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#0a1628] via-[#0f1e3a] to-[#050a14] ">
      ...
      <div className="absolute inset-0 z-10 overflow-hidden">
        <div className="absolute top-[15%] right-[15%] animate-float-slow">
          <div className="relative">
            ...
            <svg
              className=" w-8 h-8 lg:w-16 lg:h-16 relative z-10"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
        ...
        <div className=" hidden md:block absolute top-[20%] left-[12%] animate-float-medium">
          <div className="relative">
            <div className="absolute inset-0 blur-xl bg-amber-500/50 rounded-full" />
            <svg
              className=" w-8 h-8 lg:w-12 lg:h-12 relative z-10 text-amber-400"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
        ...
        {/* <div className="hidden lg:absolute md:top-[20%] md:left-[12%] md:animate-float-medium">
          <div className="relative">
            <div className="absolute inset-0 blur-xl bg-amber-500/50 rounded-full" />
            <svg
              className="w-8 h-8 lg:w-12 lg:h-12 relative z-10 text-amber-400"
        ...
        <div className="absolute top-[20%] left-[10%] lg:top-[45%] lg:left-[10%] animate-float-fast">
          <div className="relative">
            <div className="absolute inset-0 blur-xl bg-amber-500/50 rounded-full" />
            <svg
              className=" w-8 h-8 lg:w-12 lg:h-12 relative z-10 text-amber-400"
        ...
        <div className="absolute top-[32%] right-[8%] lg:top-[50%] lg:right-[8%] animate-float-medium">
          <div className="relative">
            <div className="absolute inset-0 blur-xl bg-amber-500/50 rounded-full" />
            <svg
              className=" w-8 h-8 lg:w-12 lg:h-12 z-10 text-amber-400"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen px-4 lg:pt-20 pb-32">
        <div className="text-center max-w-4xl mx-auto space-y-8">
          ...
          <div className="pt-0 flex justify-center pb-8">
            <button
              onClick={handleClickStarted}
              className="relative bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-500 hover:to-yellow-500 text-white px-4 py-2 lg:px-12 lg:py-6 text-lg font-semibold rounded-lg shadow-lg shadow-amber-500/50 hover:shadow-amber-500/70 transition-all duration-300 border-2 border-amber-400/50 overflow-hidden group"
            >
      ...
      <div className="absolute  bottom-20 left-0 right-0 z-10 w-full h-auto bg-gradient-to-t from-[#050a14] via-[#050a14]/80 to-transparent">
        <svg
          className=" lg:mt-32 w-auto lg:w-[80%] h-auto mx-auto"
      ...
      <div className="absolute bottom-20 left-0 right-0 z-10 w-full h-auto bg-gradient-to-t from-[#050a14] via-[#050a14]/80 to-transparent">
        {/* Desktop SVG */}
        <svg
          className="hidden lg:block lg:mt-20 w-auto lg:w-[80%] h-auto mx-auto"
          viewBox="0 0 1400 400"
          preserveAspectRatio="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          ...
          {/* Your existing full SVG code here */}
        </svg>

        {/* Mobile right-half SVG */}
       <div className=" block lg:hidden w-full overflow-hidden">
      <div className=" mt-8 flex justify-center items-center gap-6 w-full px-4 ">
        {/* Left Image */}
        <div className="w-1/2 h-auto md:w-1/4 md:h-auto bg-yellow-100 p-1">
          <Image
            src={left}
            alt="Left Part"
        ...
        {/* Right Image */}
        <div className=" w-1/2 h-auto md:w-1/4 md:h-auto mt-18 bg-yellow-100 p-1 ">
          <Image
            src={right}
            alt="Right Part"
            className=" w-full h-auto  object-contain"
